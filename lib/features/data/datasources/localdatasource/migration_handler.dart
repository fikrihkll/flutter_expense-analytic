  ...
  static List<Migration> migrations = [
    ...
    Migration(
        ...
        sql: [
          ...
          "ALTER TABLE ${DatabaseHandler.tableUsers} ADD COLUMN user_uuid TEXT NOT NULL DEFAULT 'abc'",
          "ALTER TABLE ${DatabaseHandler.tableFundSources} ADD COLUMN budget_id TEXT",
          "ALTER TABLE ${DatabaseHandler.tableExpenses} ADD COLUMN budget_id TEXT",
